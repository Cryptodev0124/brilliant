...
const hero_content: DataType = {
  ...
  title_1: "I am Sarraf",
  words: ["Blockchain", "Cryptocurrency", "Web 3"],
  title_2: "Developer",
  sm_info: (
    <>
      My drive for blockchain innovation is fueled by an unwavering passion for smart contract engineering, 
      the art of dApp development, and a deep expertise in Web3 technologies. Recently, I have jumped into 
      non-evm including Solana, Sui, and TON, developed many projects, and acquired complete expertise in them.
    </>
  ),
          ...
          <div className="col-xl-7 col-lg-7 col-md-12">
            <div className="tp-hero-left-wrapper">
              <div className="tp-hero-content tp_text_anim p-relative z-index-1">
                <span className="singleLine">{sub_title} <Image src={HeroHand} alt="hero-hand" /></span>
                ...
                <p className="max-w-xl text-base sm:text-lg leading-relaxed text-white text-center sm:text-left">
                  {sm_info}
                </p>
          ...
          <div className="col-xl-5 col-lg-5 col-md-12">
            <div className="tp-hero-thumb-wrapper text-center text-lg-end p-relative z-index-1">
              <div className="tp-hero-thumb-shape">
                <Image className="tp-hero-thumb-shape-1" data-speed="1.4" src={HeroShape1} alt="shape-1" />
                <Image className="tp-hero-thumb-shape-2 d-none d-xl-block" data-speed="1.2" src={HeroShape2} alt="shape-2" />
                <span className="tp-hero-thumb-shape-3"></span>
              </div>
              <div className="tp-hero-thumb">
                <Image src={HeroImage} style={{ height: 'auto' }} alt="hero-img" />
              </div>
            </div>
          </div>
        </div>
