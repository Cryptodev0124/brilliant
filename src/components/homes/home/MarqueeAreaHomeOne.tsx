...
const marquee_data = [
  { text: 'Selected Work (2023)', img: stroke },
  { text: 'Sarraf Babaiev', img: smile },
  { text: 'Selected Work (2024)', img: stroke },
  { text: 'Sarraf Babaiev', img: smile },
  { text: 'Selected Work (2025)', img: stroke },
  { text: 'Sarraf Babaiev', img: smile },
]

const setting: SliderProps = {
  speed: 7000,
  autoplay: true,
  autoplaySpeed: 0,
  centerMode: true,
        ...
        <div className="tp-marquee-wrapper">
          <div className="tp-marquee-slider fix">
            {React.createElement(
              ...
              {
                ...setting,
                className: "tp-marquee-slider-active d-flex align-items-center"
              },
