...
const TestimonialAreaHomeOne = ({ style }: any) => {
  ...
  const [slider1, setSlider1] = useState<InstanceType<typeof Slider> | null>(null);
  const [slider2, setSlider2] = useState<InstanceType<typeof Slider> | null>(null);
